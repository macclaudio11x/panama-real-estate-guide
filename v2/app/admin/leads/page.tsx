              ...
              {leads.map((lead) => (
                <tr key={lead.id} className="border-b border-line-soft last:border-b-0 align-top">
                  <td className="px-4 py-3">
                    ...
                    {/* Without this an in-guide lead reads as someone who
                        couldn't be bothered to finish the form: same row, same
                        empty budget and timeline. They were never asked, and
                        the difference decides how the call opens. */}
                    {lead.intent === "article" && (
