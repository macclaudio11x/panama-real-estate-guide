...
export const articles: Article[] = [
  { slug: "apartments-for-rent-panama-city", categorySlug: "living", title: "Renting an apartment in Panama City: the law almost none of it applies to your lease", dek: "Panama's rental statute sets a three-year minimum term and a government-held deposit. A 1994 decree excludes anything renting above B/.150 a month from most of it, which is why almost none of it governs the apartment you're about to sign for.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 9 },
  { slug: "apostille-documents-panama-visa", categorySlug: "residency", title: "Apostille for Panama residency: what actually needs it, and what it costs", dek: "Panama joined the Hague Apostille Convention in 1991, the US in 1981, and Migración's own requirement sheets never use the word apostille. What the paperwork actually asks for, sourced to HCCH and Migración, with two states checked directly on fee and turnaround.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 11 },
  ...
  { slug: "best-beaches-panama-expats", categorySlug: "living", title: "Panama's beach towns for expats: the one you can't buy, and what's actually in the water", dek: "You cannot buy or lease land in San Blas under any circumstances, a Guna law most beach lists skip. A 2023 university study found a popular Coronado-corridor beach failed safe-bathing limits, worse in dry season than rainy season.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 8 },
  { slug: "best-neighborhoods-panama-city-expats", categorySlug: "buying", title: "Panama City neighborhoods for expats: what's real, what's marketing, and what no one tracks", dek: "No Panamanian institution publishes price, rent or crime data below the province level. Costa del Este, Punta Pacífica and six other zones expats actually compare, on the facts that are checkable and the ones that are not.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 13 },
  ...
  { slug: "moving-to-panama-from-canada", categorySlug: "living", title: "Moving to Panama from Canada: the tax withholding nobody's relocation guide mentions", dek: "Canada withholds 25% of every CPP and OAS payment sent to a retiree in Panama, not the 15% a retiree gets in a treaty country, because Canada and Panama have an information-exchange agreement, not a tax treaty. That single fact changes the math on every other guide written for a generic expat.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 12 },
  ...
  { slug: "panama-healthcare-costs-2026", categorySlug: "living", title: "Healthcare in Panama: what CSS, Migración and the hospitals actually publish", dek: "Panama's Caja de Seguro Social will insure a foreign retiree from $110 a month, bundled with a pension contribution you cannot opt out of. None of the three residency permits most retirees use requires proof of health insurance. Both come from the primary documents, not a relocation blog's guess.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 11 },
  ...
  { slug: "panama-real-estate-investment-lifestyle-2026", categorySlug: "buying", title: "Panama real estate as an investment: the taxes that actually apply", dek: "DGI taxes an investment property's assessed value at up to 1% a year and the rental income it produces at up to 25%, both published brackets. No Panamanian institution publishes the zone-by-zone yield or appreciation percentage this page used to lead with.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 8 },
  { slug: "panama-real-estate-market-2026", categorySlug: "buying", title: "Panama real estate market 2026: what's actually moving, and what no institution tracks", dek: "INEC recorded a 26% jump in permitted construction area for Q1 2026, the clearest official read on Panama's building market there is. Zone-by-zone resale pricing, appreciation percentages and 'sold out' claims do not come from any Panamanian institution.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 11 },
  ...
  { slug: "panama-sim-card-guide", categorySlug: "living", title: "SIM cards in Panama: two carriers, and the passport rule most guides skip", dek: "Claro folded into +Móvil in 2022. Digicel closed entirely in April 2024. What's left is Tigo and +Móvil, and ASEP will not let either one activate your SIM without a passport or cédula, a registration law most relocation guides never mention.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 9 },
  ...
  { slug: "panama-vs-belize-retirement", categorySlug: "living", title: "Panama vs Belize for retirement: what each government actually requires", dek: "Panama's pensionado visa requires a $1,000-a-month lifetime pension, or $750 with a $100,000 property. Belize's QRP requires $2,000 a month from outside the country, no property needed. Both numbers come from the agencies that run the programs, sourced here instead of a broker's spreadsheet.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 10 },
  ...
  { slug: "panama-vs-costa-rica-retirement", categorySlug: "living", title: "Panama vs Costa Rica for retirement: what each government actually requires", dek: "Panama's Pensionado visa needs a lifetime pension of B/.1,000 a month. Costa Rica's Pensionado needs almost the identical $1,000 a month. The two programs diverge everywhere else: Costa Rica also has a $2,500-a-month Rentista route, and mandates enrollment in its public insurer as a condition of residency, something Panama does not require at all. Sourced to each government's own regulation, not a relocation blog's spreadsheet.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 11 },
  ...
  { slug: "panama-weather-rainy-season-guide", categorySlug: "living", title: "Panama's rainy season: May to November, and the hurricane season that isn't", dek: "IMHPA, not ETESA, has run Panama's weather service since 2023, and it puts the rainy season at May through November, wettest in September and October. In NOAA's full 173-year Atlantic hurricane record, exactly one storm has ever made landfall in the country.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 11 },
  ...
  { slug: "real-cost-of-moving-to-panama", categorySlug: "money", title: "The real cost of moving to Panama: what's sourced, and the two numbers nobody publishes", dek: "Friendly Nations residency clears with two government cheques totaling B/.1,050, not a vague \"visa fee.\" The household goods exemption is B/.25,000 for any new resident. Container shipping and immigration legal fees have no institutional source at all, so a single all-in total, including the one this page used to publish, would be invented rather than sourced.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 12 },
  { slug: "retire-in-panama", categorySlug: "living", title: "Retiring in Panama: the Pensionado threshold, and what else the government actually requires", dek: "Panama's Pensionado visa runs on a lifetime pension of B/.1,000 a month, or B/.750 with more than B/.100,000 in Panamanian property. That is not the $1,350 figure most retirement guides still quote. Sourced to Migración, CSS and the DGI's own requirement sheets, not a relocation blog's spreadsheet.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 12 },
  ...
  { slug: "sending-money-panama-wire-transfer", categorySlug: "money", title: "Sending money to Panama: what Wise, Remitly, and a bank wire actually cost", dek: "Wise charges $9.03 to move $10,000 into a Panama bank account by ACH, according to its own live calculator checked in August 2026. A bank wire covering the same $10,000 costs at least $82.45 once Bank of America's outgoing fee meets Banco General's incoming fee, and Panama does not tax the wire itself at 3.4 percent, whatever the earlier version of this page said.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 12 },
  { slug: "start-business-panama-foreigners", categorySlug: "residency", title: "Starting a business in Panama as a foreigner: what DGI actually taxes, and what it costs", dek: "Panama taxes income \"produced within the territory of the Republic,\" not income paid by a foreign client. Article 694 of the Código Fiscal draws that line, and a services company run out of a Panama office does not automatically land on the tax-free side of it. Sourced to the Código Fiscal, Registro Público, MICI and Migración, with the fabricated cost tables and success stories removed.", authorSlug: "editorial-team", reviewerSlug: null, updatedOn: "August 2026", readMinutes: 15 },
